export class ChallengeResult {
  ...
  constructor(uid: string, challenge_id: string, resultat_obtenu : string, temps_execution: number, user_id: string, created_at: string, updated_at: string, used_language: string, username ?: string) {
    this.uid = uid;
